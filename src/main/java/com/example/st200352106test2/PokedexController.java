...
public class PokedexController implements Initializable {
    ...
    /**
     * Tried multiple things and could not figure out the button! Here is a cheat that I could just repeat 9 times
    ...
    void viewNextPokemon()
    {
        ...
        nameLabel.setText(pokemon2.getName());
        numberLabel.setText(String.valueOf(pokemon2.getPokemonNumber()));
        genderLabel.setText(pokemon2.getGender());
        hPLabel.setText(String.valueOf(pokemon2.getHp()));
        attackLabel.setText(String.valueOf(pokemon2.getAttack()));
        defenseLabel.setText(String.valueOf(pokemon2.getDefense()));
